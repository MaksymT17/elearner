...
<script runat="server">
    ...
    {         
        if (FileUpload1.HasFile)
        {
            ...
            string savePath = appPath + "Images\\Events\\" + MVCbug.Models.MyContext.Current.eventId + ".jpg";
        ...
        string newsavePath = newappPath + "Images\\Events\\" + MVCbug.Models.MyContext.Current.eventId + ".jpg";
        // applicaton  path directory    
        if( System.IO.File.Exists(newsavePath)==false)
        {
        System.IO.File.Copy(newappPath + "Images\\Events\\noPhoto.jpg", newsavePath);            
        }
    }
</script>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	<%= Resources.ResourceUA.AddPhoto %>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <h2><%= Resources.ResourceUA.AddPhoto %></h2>
<form id="form1" runat="server">
    
    <asp:FileUpload ID="FileUpload1" runat="server"
        onunload="FileUpload1_Unload" OnDataBinding="FileUpload1_Unload" OnDisposed="FileUpload1_Unload"
         OnInit="FileUpload1_Unload" OnLoad="FileUpload1_Unload" OnPreRender="FileUpload1_Unload"/>
         <input id="Submit1" type="submit" value="Завантажити" />
    </form>
</asp:Content>
